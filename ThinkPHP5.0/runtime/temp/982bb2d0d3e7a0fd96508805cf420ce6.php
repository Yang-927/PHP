<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"C:\phpstudy_pro\WWW\ThinkPHP5.0\public/../application/index\view\login\login.html";i:1574678641;}*/ ?>
	...
	<div class="main">
		<div class="login-form fr">
			...
			<div class="form-bd">
				...
				<dl>
					<dt>&nbsp;</dt>
					<dd> 还不是本站会员？立即 <a href="http://www.thinkphp5.com/index/Login/register" class="register">注册</a></dd>
				</dl>
				<dl class="other">
					<dt>&nbsp;</dt>
					<dd>
