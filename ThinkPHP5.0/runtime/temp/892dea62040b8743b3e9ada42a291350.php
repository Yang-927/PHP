<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"C:\phpstudy_pro\WWW\ThinkPHP5.0\public/../application/index\view\index\list.html";i:1572421564;}*/ ?>
		...
		<div class="shop_bd_list_right clearfix">
			...
			<div class="shop_bd_list_content clearfix">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="/index/Index/goods_detail?id=<?php echo $v['id']; ?>"><img src="<?php echo $v['goods_img']; ?>" /></a></dt>
							<dd class="title"><a href=""><?php echo $v['goods_name']; ?></a></dd>
							<dd class="content">
								<span class="goods_jiage">￥<strong><?php echo $v['shop_price']; ?></strong></span>
