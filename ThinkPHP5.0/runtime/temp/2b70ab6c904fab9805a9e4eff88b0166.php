<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"C:\phpstudy_pro\WWW\ThinkPHP5.0\public/../application/index\view\index\index.html";i:1574645034;}*/ ?>
			...
			<div class="shop_hd_topNav_all">
				...
				<div class="shop_hd_topNav_all_right">
					<ul class="topNav_quick_menu">
							...
							<div class="topNav_menu">
								...
								<div class="topNav_menu_bd" style="display:none;" >
						            <ul>
						              ...
						              <li><a title="个人主页" target="_top" href="/index/Car/order_list">个人主页</a></li>
						...
						<li>
							<div class="topNav_menu">
								<a href="/index/Car/car_list" class="topNavHover">购物车<b><?php echo $cart_num; ?></b>种商品<i></i></a>
								<div class="topNav_menu_bd" style="display:none;">
									<!--
						            <ul>
						              <li><a title="已售出的商品" target="_top" href="#">已售出的商品</a></li>
						...
						<li>
							<div class="topNav_menu">
								...
								<div class="topNav_menu_bd" style="display:none;">
						            <ul>
						              <li><a title="收藏的商品" target="_top" href="/index/Index/favo">收藏的商品</a></li>
		...
		<div class="shop_hd_menu">
			...
			<div class="shop_hd_menu_all_category shop_hd_menu_hover"><!-- 首页去掉 id="shop_hd_menu_all_category" 加上clsss shop_hd_menu_hover -->
				...
				<div id="shop_hd_menu_all_category_hd" class="shop_hd_menu_all_category_hd">
					...
					<!-- 单个菜单项 -->
						<?php if(is_array($cat_list) || $cat_list instanceof \think\Collection || $cat_list instanceof \think\Paginator): if( count($cat_list)==0 ) : echo "" ;else: foreach($cat_list as $k=>$v): if($k<8): ?>
							
							<li id="cat_1" class="">
							<h3><a href="/index/Index/goods_list?cat_id=<?php echo $v['id']; ?>" title="男女服装"><?php echo $v['cat_name']; ?></a></h3>
							</li>	
