<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"C:\phpstudy_pro\WWW\ThinkPHP5.0\public/../application/index\view\car\flow2.html";i:1575336388;}*/ ?>
<!DOCTYPE html
...
<head>
	...
	<title>购物车页面</title>
	<base href="http://www.thinkphp5.com/static/" />
	...
	<div class="shop_hd">
		...
		<div class="shop_hd_header">
			<div class="shop_hd_header_logo">
				<h1 class="logo"><a href="/"><img src="images/logo.png" alt="ShopCZ" /></a><span>ShopCZ</span></h1>
			</div>
	...
	<div class="shop_gwc_bd clearfix">
		<div class="shop_gwc_bd_contents clearfix">
			...
			<div class="shop_bd_shdz_title">
				<h3>收货人地址</h3>
				<p><a href="javasrcipt:void(0);" id="new_add_shdz_btn">新增收货地址</a><a
						href="javascript:void(0);">管理收货地址</a></p>
			</div>
			<div class="clear"></div>
			<!-- 收货人地址 Title End -->
			<div class="shop_bd_shdz clearfix">
				<div class="shop_bd_shdz_lists clearfix">
					<ul class="reg_list">
						...
						<li><label>寄送至：<span><input
										type="radio" class="address_id" name = "address" value = "<?php echo $v['id']; ?>" /></span></label><em><?php echo $v['province_name']; ?></em><em><?php echo $v['city_name']; ?></em><em><?php echo $v['county_name']; ?></em><em><?php echo $v['address']; ?></em><em><?php echo $v['user_name']; ?>(收)</em><em><?php echo $v['mobile']; ?></em>

							<a style="float:right;margin-right:30px;" href="javascript:void(0)" class="del" ip="<?php echo $v['id']; ?>">删除</a>
							<a style="float:right;margin-right:30px;" href="/index/Address/upd?id=<?php echo $v['id']; ?>">编辑</a>
						</li>
						<?php endforeach; ?>
					</ul>
				</div>
							...
							<ul>
								...
								<li><label for=""><span>*</span>所在地址：</label>
									<select class="province">
										...
										<option value="<?php echo $v['region_id']; ?>" region_type="2"><?php echo $v['region_name']; ?></option>
										<?php endforeach; ?>
									</select>
									<select class="city">
										<option value="0">请选择</option>
								...
								<li><label for="">&nbsp;</label><input type="button" class="btn1" value="增加收货地址" /></li>
							</ul>
							</from>
					</div>
				</div>
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<td class="gwc_list_pic"><a href="/index/Index/goods_detail?id=<?php echo $v['id']; ?>"><img width="100px" src="<?php echo $v['goods_img']; ?>" /></a></td>
						<td class="gwc_list_title"><a href=""><?php echo $v['goods_name']; ?></a></td>
						<td class="gwc_list_danjia"><span>￥<strong id="danjia_001"><?php echo $v['shop_price']; ?></strong></span></td>
						<td class="gwc_list_shuliang"><span><?php echo $v['number']; ?></span></td>
						<td class="gwc_list_xiaoji"><span>￥<strong id="xiaoji_001" class="good_xiaojis"><?php echo $v['shop_price'] *
									$v['number']; ?></strong></span></td>
					</tr>
					<?php endforeach; ?>
				</tbody>
				<tfoot>
					<tr>
						<td colspan="6">
							<div class="gwc_foot_zongjia">商品总价(不含运费)<span>￥<strong
										id="good_zongjia">12750.00</strong></span></div>
							<div class="clear"></div>
							<div class="gwc_foot_links">
								<a href="/index/Car/car_list" class="go">返回上一步</a>
								<a href="javascript:void(0);" order_id="<?php echo $order_id; ?>" class="op">确认购买</a>
							</div>
						</td>
					</tr>
				</tfoot>
...
<script>
	$('.province').change(function(){
		...
		var region_type = $(this).children('option:selected').attr('region_type');
		$.ajax({
			url:'/index/Car/getRegion',
			type:'post',
			dataType:'json',
			...
			success:function(res){
				...
				$.each(res, function(i, d) {
					$(".city").append(
						"<option value='"+d.region_id+"' region_type='3'>" + d.region_name
									+ "</option>");
					})
			}		
		})
	...
	$('.city').change(function(){
		...
		$.ajax({
			...
			success:function(res){
				...
				$.each(res, function(i, d) {
					$(".county").append(
						"<option value='"+d.region_id+"'>" + d.region_name
									+ "</option>");
					})
			}		
		})
	...
	$(".btn1").click(function(){
		...
		$.ajax({ 
			url:'/index/Address/add_add',
			type:'post',
			dataType:'json',
			data:{user_name,province_id,city_id,county_id,address,mobile},
			success:(res) => {
				if (res.error_code == 1) {
					alert(res.error_msg)
					...
					$.each(res.data,function(k,v) {
						$('.reg_list').append('<li><label>寄送至：<span><input type="radio" class="address_id" value = "'+v.id+'" name = "address" /></span></label><em>'+v.province_name+'</em><em>'+v.city_name+'</em><em>'+v.county_name+'</em><em>'+v.address+'</em><em>'+v.user_name+'(收)</em><em>'+v.mobile+'</em><a style="float:right;margin-right:30px;" href="javascript:void(0)" class="del" ip="'+v.id+'">删除</a><a style="float:right;margin-right:30px;" href="/index/Address/upd?id=v.id">编辑</a></li>')
