<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"C:\phpstudy_pro\WWW\TP5.0\public/../application/index\view\address\address_edit.html";i:1574167706;}*/ ?>
			...
			<div class="shop_meber_bd_good_lists clearfix">
				...
				<dic class="shop_home_form">
					<form athion="" name="" class="shop_form" method="post">
						<ul>
							<li><label><span>*</span>收货人姓名：</label><input type="text" name="user_name" class="form-text" value="望乐乐" /></li>
							<li><label>详细地址：</label>
									<select>
							...
							<li><label>详细地址：</label><input type="text" name="address" class="form-text" value="" /></li>
