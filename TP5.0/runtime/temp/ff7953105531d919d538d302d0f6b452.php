<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"C:\phpstudy_pro\WWW\TP5.0\public/../application/index\view\car\flow2.html";i:1574301086;}*/ ?>
<!DOCTYPE html
		...
		<div class="shop_gwc_bd_contents clearfix">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<td class="gwc_list_pic"><a href=""><img width="100px" src="<?php echo $v['goods_img']; ?>" /></a></td>
			...
			success:(res) => {
				if (res.error_code == 1) {
					...
					$.each(res.data,function(k,v) {
						$('.reg_list').append('<li><label>寄送至：<span><input type="radio" id = "'+v.id+'" name = "address" /></span></label><em>'+v.province_name+'</em><em>'+v.city_name+'</em><em>'+v.county_name+'</em><em>'+v.address+'</em><em>'+v.user_name+'(收)</em><em>'+v.mobile+'</em><a style="float:right;margin-right:30px;" href="javascript:void(0)" class="del" ip="'+v.id+'">删除</a><a style="float:right;margin-right:30px;" href="/index/Address/upd?id=v.id">编辑</a></li>')
