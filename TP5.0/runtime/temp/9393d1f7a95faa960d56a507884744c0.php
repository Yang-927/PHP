<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"C:\phpstudy_pro\WWW\TP5.0\public/../application/admin\view\index\menu.html";i:1571704678;}*/ ?>
		...
		<div id="menu-list">
			<ul id="menu-ul">
				<li class="explode" key="02_cat_and_goods" name="menu"> 商品管理        
					<ul>
						  <li class="menu-item"><a href="/admin/Goods/goods_list" target="main-frame">商品列表</a></li>
						  <li class="menu-item"><a href="goods.php?act=add" target="main-frame">添加新商品</a></li>
						  <li class="menu-item"><a href="/admin/Goods/type_list" target="main-frame">商品类型</a></li>
              <li class="menu-item"><a href="/admin/Category/cat_list" target="main-frame">商品分类</a></li>
