<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:75:"C:\phpstudy_pro\WWW\TP5.0\public/../application/index\view\index\goods.html";i:1573711312;}*/ ?>
		...
		<div class="shop_goods_show">
			...
			<div class="shop_goods_show_right">
				<ul>
					...
					<li style="padding:20px 0;">
						<label>&nbsp;</label>
						<span><a href="/index/Index/goods_favo?id=<?php echo $data['id']; ?>" is_sale='' class="" >加入收藏</a></span>
					</li>
				</ul>
			</div>
		</div>
