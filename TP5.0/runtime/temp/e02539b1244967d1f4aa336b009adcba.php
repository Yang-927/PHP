<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"C:\phpstudy_pro\WWW\TP5.0\public/../application/index\view\car\order.html";i:1574651235;}*/ ?>
													...
													<tr>
														<td>
															<table border-right="0">
																<?php foreach($v['goods_data'] as $i): ?>
																	<tr>
																		<td class="dingdan_pic">
																			<img src="<?php echo $i['goods_img']; ?>" />
																		</td>
																		<td class="dingdan_title">
																			<span><a href=""><?php echo $i['goods_name']; ?></a></span>
																		</td>
																		<td class="dingdan_danjia">
																			￥<strong>25.00</strong>
																		</td>
															...
															<table>
																<tr>
																	<td class="dingdan_zongjia">
																		￥<strong><?php echo $v['total_price']; ?></strong><br />(免运费)
																	</td>
																	<td class="digndan_caozuo">
																		<a href=""><?php echo $v['status_desc']; ?></a>
																	</td>
																</tr>
															</table>
														</td>
