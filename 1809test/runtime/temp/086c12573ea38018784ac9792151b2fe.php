<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"C:\phpstudy_pro\WWW\1809test\public/../application/index\view\index\list.html";i:1573457391;}*/ ?>
				...
				<ul>
					...
					<li>
						<dl>
							...
							<dd class="title"><a href="/index/Index/goods_detail?id=<?php echo $v['id']; ?>"><?php echo $v['goods_name']; ?></a></dd>
							<dd class="content">
								<span class="goods_jiage">￥<strong><?php echo $v['price']; ?></strong>元</span>
