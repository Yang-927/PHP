...
<head>
	...
	<style>
		body{
			background:url("<?php echo $array['Img'] ?>") no-repeat center;
			background-size:100%;
		}
		body:after{
			content: "";
		...
		.cont form:after{
			...
			content:'';
			display:block;
			background:url("img/Curry1.jpg") no-repeat;
			opacity:0.5;
			position:absolute;
			left:0;
			top:0;
...
<body>
	<nav class="navbar navbar-default">
		...
		<div class="container upd">
			<div class="titleBox">
				<h1 class="title">文章修改页</h1>
				<p class="back"><a href="./details.php?act=details&table=essay&id=<?php echo $array['id'];?>">返回详情页……</a></p>
				<hr>
			</div>
			<div class="cont">
				<form action="./curd.php?act=update&table=essay&id=<?php echo $array['id'] ?>" method="post" enctype="multipart/form-data">
					<table align="center" height="400" width="400" border="0" cellspacing="0" cellpadding="10">
						...
						<tr>
							...
							<td>
								<div class="inputText">
									<textarea name="Cont" cols="30" rows="10">
										<?php echo $array['Cont'] ?>
									</textarea>
								</div>
							</td>
